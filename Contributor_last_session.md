> Hello! Can you help me connect this working dir with my github repositoories (github.com/anarcoiris) and propose a
 list of a few ones that could be included in my jupyter notebooks? They are exposed under a ngrok tunnel for
recruiters to see my CV portfolio. I'd like to port everything that could be interesting for Data Engineer, Data
Science, Data Architect and/or other roles. Also we should schedule a review of the current notebooks already in
this dir. Do /init and generate the required /agent or group of agents that should distribute the specialized tasks
of this session
...
│ ## Executive Summary                                                                                                 │
│                                                                                                                      │
│ This plan integrates selected GitHub repositories from github.com/anarcoiris into the Jupyter Notebooks portfolio    │
│ directory. The goal is to showcase comprehensive data engineering, machine learning, and analytical capabilities to  │
│ recruiters.                                                                                                          │
│                                                                                                                      │
│ **Current State:**                                                                                                   │
...
│ cd "C:\Users\aladin\Documents\Portfolio\stable\Jupyter Notebooks"                                                    │
│ git init                                                                                                             │
│ mkdir -p ML_Finance ML_GameTheory NLP NLP_Engineering Cloud_Integration Distributed_Systems DevOps_Tools             │
│ Statistical_Modeling                                                                                                 │
│                                                                                                                      │
...
│                                                                                                                      │
│ ```cmd                                                                                                               │
│ mklink /D "C:\Users\aladin\Documents\Portfolio\stable\Jupyter Notebooks\ML_Finance\ffws_GARCHLSTM"                   │
│ "C:\path\to\original\ffws_GARCHLSTM"                                                                                 │
│ ```                                                                                                                  │
│                                                                                                                      │
...
of this session
  ...
  Todos
  [×] Explore current Jupyter notebooks in working directory
  [×] Fetch GitHub repositories from github.com/anarcoiris
  [×] Analyze repos for Data Engineering/Science/Architecture relevance
  [×] Review existing notebooks in directory
  [ ] Propose integration plan for selected repositories
  [ ] Generate recommendations for portfolio presentation
